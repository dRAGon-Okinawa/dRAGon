                        ...
                        <div class="border-1 surface-border border-round m-2 p-3">
                            <div class="mb-3">
                                <div class="relative mx-auto">
                                    <img :src="'/images/dragon_okinawa_icon.png'" :alt="slotProps.data.name" class="w-full border-round" />
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="flex justify-content-center">
                    <Image :src="'/images/dragon_okinawa_icon.png'" alt="Image" width="250" preview />
                </div>
            </div>
        </div>
