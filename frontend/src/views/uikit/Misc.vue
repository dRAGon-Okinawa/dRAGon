    ...
    <div class="grid">
        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <AvatarGroup class="mb-3">
                    <Avatar :image="'/images/dragon_okinawa_icon.png'" size="large" shape="circle"></Avatar>
                    <Avatar :image="'/images/dragon_okinawa_icon.png'" size="large" shape="circle"></Avatar>
                    <Avatar :image="'/images/dragon_okinawa_icon.png'" size="large" shape="circle"></Avatar>
                    <Avatar :image="'/images/dragon_okinawa_icon.png'" size="large" shape="circle"></Avatar>
                    <Avatar :image="'/images/dragon_okinawa_icon.png'" size="large" shape="circle"></Avatar>
        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <h5>Image</h5>
                <div class="flex align-items-center flex-column sm:flex-row">
                    <Chip label="Amy Elsner" :image="'/images/dragon_okinawa_icon.png'" class="mr-2 mb-2"></Chip>
                    <Chip label="Asiya Javayant" :image="'/images/dragon_okinawa_icon.png'" class="mr-2 mb-2"></Chip>
                    <Chip label="Onyama Limba" :image="'/images/dragon_okinawa_icon.png'" class="mr-2 mb-2"></Chip>
                </div>
            </div>
