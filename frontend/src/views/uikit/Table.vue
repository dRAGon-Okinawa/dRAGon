                            ...
                            <MultiSelect v-model="filterModel.value" :options="representatives" optionLabel="name" placeholder="Any" class="p-column-filter">
                                <template #option="slotProps">
                                    <div class="p-multiselect-representative-option">
                                        <img :alt="slotProps.option.name" :src="'/images/dragon_okinawa_icon.png'" width="32" style="vertical-align: middle" />
        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable :value="products" v-model:expandedRows="expandedRows" dataKey="id" tableStyle="min-width: 60rem">
                    ...
                    <Column header="Image">
                        <template #body="slotProps">
                            <img :src="'/images/dragon_okinawa_icon.png'" :alt="slotProps.data.image" class="shadow-2" width="100" />
                        </template>
                    </Column>
            ...
            <div class="card">
                ...
                <DataTable :value="customer3" rowGroupMode="subheader" groupRowsBy="representative.name" sortMode="single" sortField="representative.name" :sortOrder="1" scrollable scrollHeight="400px">
                    ...
                    <template #groupheader="slotProps">
                        <div class="flex align-items-center gap-2">
                            <img :alt="slotProps.data.representative.name" :src="'/images/dragon_okinawa_icon.png'" width="32" style="vertical-align: middle" />
