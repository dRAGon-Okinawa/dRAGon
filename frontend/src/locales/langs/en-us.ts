const local: App.I18n.Schema = {
  ...
  route: {
    ...
    help: 'Help',
    manage: 'Management',
    'manage_silo-list': 'Silos',
    'manage_silo-detail': 'Silo Detail',
    exception: 'Exception',
    exception_403: '403',
    exception_404: '404',
    exception_500: '500'
  ...
  page: {
    ...
    about: {
      title: 'About',
      introduction: `dRAGon is a multi-modal RAG engine which can search over multiple kind of documents to generate good quality answers for LLMs.`,
      projectInfo: {
        title: 'Project Info',
        version: 'Version',
